...
class KafkaConsumerWrapper(config: KafkaConfig, groupId: String, offset: String) {
    ...
    init {
        ...
        */
        ...
        props[ConsumerConfig.GROUP_ID_CONFIG] = groupId /* Group ID each time Consumer Created */
