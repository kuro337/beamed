...
fun main() {
    ...
    Pipeline.create().apply {
        readParquetToGenericRecord<FredSeries>(
            listOf(
                "data/output/beam/parquet/output-00000-of-00005.parquet",
                "data/output/beam/parquet/output-00001-of-00005.parquet",
                "data/output/beam/parquet/output-00002-of-00005.parquet",
                "data/output/beam/parquet/output-00003-of-00005.parquet",
            )
        ).apply {
